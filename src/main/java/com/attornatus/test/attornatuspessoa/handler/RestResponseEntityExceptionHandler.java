package com.attornatus.test.attornatuspessoa.handler;
...
public class RestResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorApiResponse> formatoInvalidoException (Exception ex) {
		return ResponseEntity.status(HttpStatus.BAD_REQUEST)
				.body(ErrorApiResponse.builder()
						.message("FORMATO INVALIDO NA REQUEST")
